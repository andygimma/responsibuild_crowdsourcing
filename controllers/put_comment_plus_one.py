...
from controllers.datastore_results import datastore_results
from controllers.plus_one_constraints import plus_one_constraints
from controllers.comment_plus_one_constraints import comment_plus_one_constraints
import random

def put_comment_plus_one(self):
    ...
    if check_login(self):
        ...
        if continue_boolean:
            ...
            if comment_plus_one_constraints(self, comment_id):
                ...
                if key is not None:
                    ...
                    if results_exist:
                        ...
                        pm = model.CommentPlusMinusConstraints(email = email, comment_id = comment_id, points = points + 1)
                        pm.put()
